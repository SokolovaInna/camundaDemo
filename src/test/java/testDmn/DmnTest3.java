...
public class DmnTest3 {
    ...
    public ProcessEngineRule processEngineRule = new
            ProcessEngineRule();
    public DmnTest3(final String country, final boolean
            expectedResult) {
        this.country = country;
        this.expectedResult = expectedResult;
    }
    @Test
    @Deployment(resources = {"dmn_2.dmn"})
    public void
    givenCountry_whenEvaluatingDmnTable_thenReturnCorrectResult() {
        ...
        final DmnDecisionTableResult actRes =
                decisionService.evaluateDecisionTableByKey("FriendlyNationDecision",
                        variables);
        assertEquals(1, actRes.size());
        assertEquals(country, expectedResult,
                actRes.getSingleResult().getEntry("is_friendly"));
    }
}
